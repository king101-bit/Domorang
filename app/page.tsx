    ...
    <>
      ...
      <section className="py-20 md:py-32">
        <div className="mx-auto max-w-md px-6 text-center">
          ...
          <div className="bg-primary-50 max-w-sm rounded-2xl border-2 border-[#0891B2] p-8">
            <h3 className="text-primary-600 mb-3 text-xs font-semibold tracking-wide">
              THE STORY
            </h3>
            <h2 className="mb-6 text-2xl font-bold">Why Domorang Exists</h2>
