    ...
    <section className="py-20 md:py-32">
      <div className="mx-auto max-w-6xl px-6">
        <div className="mb-16 text-center">
          <h2 className="mb-6 text-[28px] font-bold text-gray-900 transition-all duration-700 md:text-[45px]">
        ...
        <div className="mb-12 grid grid-cols-1 gap-8 sm:grid-cols-2">
          {problems.map((problem, index) => {
            ...
            return (
              <div
                key={index}
                className="border-primary-300 hover:border-primary-300 flex items-start gap-4 rounded-2xl border bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
              >
